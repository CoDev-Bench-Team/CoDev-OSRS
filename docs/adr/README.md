...
| [0006](0006-assets-and-inventory.md) | Assets and Inventory are separate; per-office stock, reserved on submit |
| [0007](0007-fulfilment-status-vocabulary.md) | One handover state (For Delivery / For Pickup), completed by the Admin |
