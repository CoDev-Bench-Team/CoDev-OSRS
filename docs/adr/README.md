...
| [0007](0007-fulfilment-status-vocabulary.md) | One handover state (For Delivery / For Pickup), completed by the Admin — amended 2026-09-24: `Ready for Pickup`, drawn pink/blue pills |
| [0008](0008-per-unit-inventory-register.md) | Inventory is a per-unit register; stock is counted from unit statuses |
