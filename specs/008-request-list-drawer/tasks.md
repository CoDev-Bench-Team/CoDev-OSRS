...
- [x] T011 [BEN-60] Update the gates D3 and D4 change: a repeat add of the same item no longer raises the badge, and the marker opens the drawer. Cite spec 008 FR-002 / D3 in each changed assertion (Known Risks 3) — `scripts/check-catalog.mjs`, `scripts/check-shell.mjs`
