...
/** MdiClipboardTextOutline — ported verbatim from design-system/components/icons/MdiClipboardTextOutline.jsx
 *  (figma node 15:539 mdi:clipboard-text-outline). Paints with `currentColor`, so colour it from the
 *  parent rather than passing a fill (spec 002 FR-014). */
export function MdiClipboardTextOutline({ size = 24, className, ...rest }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...rest}
    >
      <g transform="translate(3.0 1.021) scale(1.0 1.0)">
