...
/** A home office, in the published contract's own vocabulary — the `location`
 *  enum, transcribed rather than invented (spec 006 D3). The contract moved from
 *  `Pasig` to the design's `Ortigas` on 2026-09-24 for users, assets and
 *  inventory items alike, which settles contract conflict 2 (spec 008 D3). */
