...
import { ApprovalsQueuePage } from '../features/requests/approvals/ApprovalsQueuePage';
  ...
  return (
    <Routes>
      ...
      >
        ...
        />
        <Route path={DESTINATIONS.queue.path} element={guarded('queue', <ApprovalsQueuePage />)} />
